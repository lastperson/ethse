...
//
//        // Any can stop
//        require(now > timeStart1 + 3 minutes); //10 seconds \ 3 minutes
//        require(playerNum == 2);
//        player1Addr.transfer(bet);
//        bet = 0;
//        gameOn = false;
...
//        if (movesCount == 1){
//
//            require(now > timeStart2 + 20 seconds);  // 3 minutes
//            player2Win();
//        }
//
//        if (movesCount % 2 == 0){
//            require(now > moveTime1 + 20 seconds);
//            player1Win();
//        }
//
//        if (movesCount % 2 != 0 && movesCount != 1 ){
//            require(now > moveTime2 + 20 seconds);
//            player2Win();
//        }
//
//    }
